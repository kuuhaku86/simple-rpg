package id.ac.its.kuuhakuCorporation.simpleRPG.utils;
...
public class Sound {
	...
	public static final AudioClip scroll = Applet.newAudioClip(Sound.class.getResource("/sounds/scroll.wav"));
